...
namespace EIS.Data.Context
{
    public class ApplicationDbContext : BuilderExtension
    {
       ...
       : base(options)
        ...
        [NotMapped]
        public virtual DbSet<SP_EmployeeLeaveRequest> _sp_EmployeeLeaveRequest { get; set; }

        [NotMapped]
        public virtual DbSet<SP_GetAttendanceCountReport> _sp_GetAttendanceCountReport { get; set; }
        [NotMapped]
        public virtual DbSet<SP_GetMonthlyAttendanceData> _sp_GetMonthlyAttendanceData { get; set; }
        [NotMapped]
        ...
        [NotMapped]
        public virtual DbSet<SP_LeavePoliciesInDetail> _sp_GetLeavePoliciesInDetail { get; set; }
        [NotMapped]
        public virtual DbSet<ActualLeaveCount> _sp_GetPendingLeaveCount { get; set; }
