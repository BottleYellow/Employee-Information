...
namespace EIS.WebApp.TagHelpers
{
    ...
    public class MenuTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            String[] SubMenus = {"List Of Employees","leave Policies", "View all requests", "leave Credits","Show my leaves","Request for leave","List of Roles", "List Of Users","Manage Roles", "Attendance Reports","My Attendance History" };
